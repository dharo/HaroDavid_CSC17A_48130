 ...
 * File:   main.cpp
 * Author: davidharo
 * Gaddis 7th Edition Chapter 11 Problem 2
 */
...
int profit(MovieData);

int main(int argc, char** argv) {
    //initialize 2 MovieData variables
    MovieData movie1={"Cosmos; A Personal Voyage","Carl Sagan",1980,60, 500000, 320212};
    MovieData movie2={"Cosmos; A SpaceTime Odyssey","Neil deGrasse Tyson",2014,44,234523,456342};
